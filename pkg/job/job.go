...
// A StepsDescriptors object represents the test and cleanup steps of a single test.
// As one job might consist in multiple tests, the extended descriptor needs to capture
// a list of StepsDescriptors.
